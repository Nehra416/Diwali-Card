...
export const Card = (props) => {
    ...
    return (
        <div className='bg-black h-[160vh] text-white'>
            ...
            <div className='absolute top-10 right-10'>
                <p className='text-4xl text-[#ffbf00] '>In Advance</p>
                <h1 className='text-7xl'>Happy Diwali</h1>
                <p className='text-3xl pt-5 text-left indent-28 text-gray-300 animate-pulse'>to you and your family!</p>
                <div className='text-4xl mt-10'>
                    <p className='text-right'>REGARDS,</p>
                    <p className='text-right text-sky-800 font-bold hover:underline '>{value}</p>
                </div>
            </div>
            <div className='text-[#ffbf00] text-4xl px-44 text-center m-auto cursor-pointer h-24 ' onClick={change_quate}>
                {quate}
            </div>
            <div className='text-center mt-10 bg-gray-900 p-5'>
                <p className='text-2xl pb-5'>Create your own Card with your Name</p>
                <input type="text" placeholder='Nehra' onChange={Get} className='py-2 px-3 text-xl font-semibold border-2 rounded text-gray-600' />
                <input type="button" value="Generate" onClick={Generate} className='bg-gray-500 py-2 px-3 rounded text-xl ml-3 cursor-pointer' />
            </div>
            <div className='text-center mt-10 bg-gray-900 p-5'>
                <p>Let's Share on</p>
